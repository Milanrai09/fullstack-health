...
import { approveEditArticle } from '../hooks/adminHooks';
...
const AdminEditApproveSubPage = () => {
  ...
  const fetchArticles = async () => {
    try {
      ...
      setArticles(data.filter((article) => article.editApproved == false));
      setIsLoading(false);
    } catch (err: any) {
  ...
  return (
    <div className="admin-articles-container">
      <h1>Unapproved edit Articles</h1>
...
export default AdminEditApproveSubPage;